...
end finalizer_antminer;
------------------------------------------------------------------------------
architecture struct of finalizer_antminer is
...
p1_buttons  <= not joy_BBBBFRLDU(4) & not joy_BBBBFRLDU(8);
p2_buttons  <= not joy_BBBBFRLDU(4) & not joy_BBBBFRLDU(8); 
---------------------------------------------------------------------------
-- Main

finalizer : entity work.finalizer
  port map (
 clk_49m        => clock_48,
